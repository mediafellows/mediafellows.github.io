...
description: Offer pull fulfillment with easy self-service downloads, or push fulfillment through automated, profile-based deliveries using the MediaStore Delivery Manager.
